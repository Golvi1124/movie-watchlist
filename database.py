...
CREATE_WATCHLIST_TABLE = """CREATE TABLE IF NOT EXISTS wached (
    watcher_name TEXT,
    title TEXT
    );"""
...
INSERT_WATCHED_MOVIE = "INSERT INTO watched (watched_name, title) VALUES (?, ?);"
SET_MOVIE_WATCHED = "UPDATE movies SET watched = 1 WHERE title = ?;"


connection = sqlite3.connect(r"C:\Code\movie-watchlist\data.db")
